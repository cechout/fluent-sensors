...
namespace FluentSensors.Core.StaticInfo
{
    ...
    // intentionally does NOT label anything as "P-Core"/"E-Core"; EfficiencyClass is the raw hardware value Windows
    // itself exposes, interpreting/labeling it is a UI-layer decision for later, not a backend fact
    public record WinCpuCoreTopologyEntry(
        ...
        IReadOnlyList<int> LogicalProcessorIndices // bit positions within this core's affinity mask
    );
}